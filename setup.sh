...
git_clone() {
    ...
    git clone -b master --depth 1 https://github.com/FrancoJPerotti/sddm-astronaut-theme.git "$path_to_git_clone"/sddm-astronaut-theme
}
...
select_theme() {
    ...
    themes="astronaut black_hole cyberpunk hyprland_kath jake_the_dog japanese_aesthetic pixel_sakura pixel_sakura_static post-apocalyptic_hacker purple_leaves luminous_drift"
    ...
    echo -e "${green}[*] 11. Luminous drift${no_color}"
